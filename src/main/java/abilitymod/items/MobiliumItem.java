...
public class MobiliumItem extends Item
{
    public MobiliumItem(Properties properties) {
    ...
    public InteractionResult use(Level level, Player player, InteractionHand hand)
    {
        ...
        Ability ability = AbilityRegistry.get(abilityId, AbilityCategory.MOBILITY);
        if (ability == null) {
            return InteractionResult.FAIL;
        }
    ...
    private void spawnParticles(ServerLevel level, Player player)
    {
        ...
        level.sendParticles(AbilityParticles.MOBILIUM_PARTICLE, x, y, z, 30, 0.3D, 0.4D, 0.3D, 0.1D);
    }
