...
public class UtiliumItem extends Item
{
    public UtiliumItem(Properties properties) {
    ...
    public InteractionResult use(Level level, Player player, InteractionHand hand)
    {
        ...
        Ability ability = AbilityRegistry.get(abilityId, AbilityCategory.UTILITY);
        if (ability == null) {
            return InteractionResult.FAIL;
        }
    ...
    private void spawnParticles(ServerLevel level, Player player)
    {
        ...
        level.sendParticles(AbilityParticles.UTILIUM_PARTICLE, x, y, z, 30, 0.3D, 0.4D, 0.3D, 0.1D);
    }
