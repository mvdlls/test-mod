...
public class AggroDetonate implements Ability
{
    @Override
    public String getId() {
        return "detonate";
    ...
    public String getName() {
        return Component.translatable("abilities.aggression.detonate").getString();
    }
    ...
    public void onActivate(Level level, Player player) {
        System.out.println("Detonate activated!");
    }
}
