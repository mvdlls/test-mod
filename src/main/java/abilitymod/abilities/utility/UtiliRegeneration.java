...
public class UtiliRegeneration implements Ability
{
    @Override
    public String getId() {
        return "regeneration";
    ...
    public String getName() {
        return Component.translatable("abilities.utility.regeneration").getString();
    }
    ...
    public void onActivate(Level level, Player player) {
        System.out.println("Regeneration activated!");
    }
}